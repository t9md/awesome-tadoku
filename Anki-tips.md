...
<img src="./imgs/anki/anki-fill-image-field.gif" width="600">
...
1. PCで アプリを開く。ウェブブラウザと、Ankiを開く。
  - 外部ディスプレイがある場合はブラウザを独立したディスプレイで開いておくとよい
  - フィールドを並び替えて `image` フィールドを先頭に配置しておくと、画像をドラッグ・アンド・ドロップで `image` フィールドにコピーしやすい。
...
5. 気に入った画像をコピーし、image フィールドへ貼り付け。画像を image フィールドにドラッグアンドドロップしてもOK
