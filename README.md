...
- [tophonetics](https://tophonetics.com/): 文章を貼り付けると IPA 発音記号化。
  - IPA 化された発音記号を読むことはもちろん役立つが、その他にも面白い機能がある。日本語の表示では"カタカナ表示"が選べる。これを馬鹿にしてはいけない。日本人発音の良くある間違いは、アルファベットを見て、Phonic 読みではなく、ローマ字読みしてしまう所だ。"カタカナ表示"にして読んでみると、ローマ字読みの悪い癖に気づかせられる。つまり、"カタカナ表示"を読んで見るのは、ローマ字読みの悪い癖を"ほぐす"のに役立つ。
